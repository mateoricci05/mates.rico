...
const productos = [
  ...
  },
  {
    ...
    descripcion: "Termo Stanley Classic Vacuum Bottle 1.2L color azul marino. BPA Free, acero inoxidable, mantiene temperatura 24hs. Bombilla de regalo incluida. El clásico de Stanley en su versión más reconocida.",
    precio: 59990,
    stock: 5,
    ...
    features: [
      ...
      "Color azul marino",
      "Pico System",
      "Bombilla de regalo + caja",
    ],
  },
  {
    id: 29,
    nombre: "Stanley Classic Vacuum Bottle — Negro 1.2L",
    descripcion: "Termo Stanley Classic Vacuum Bottle 1.2L color negro mate. BPA Free, acero inoxidable, mantiene temperatura 24hs. Bombilla de regalo incluida. El más elegante de la línea Classic.",
    precio: 59990,
    stock: 5,
